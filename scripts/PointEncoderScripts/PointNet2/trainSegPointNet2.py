...
from EncoderModels.PointNet2 import PointNet2LiteBacbone, PointNet2LiteSegmentation
import torch
...
def train(model, train_loader, config):
    ...
    for epoch in range(config['num_epochs']):
        ...
        print("-" * 40)
        save_logs_json(logs, '/home/rustam/ProjectMy/artifacts/Encoders/Pn2seg/new/logs.json')
    return logs
...
if __name__ == '__main__':
    ...
    config = {
        ...
        'log_step': 10,
        'val_step': 1,
        'log_dir': '/home/rustam/ProjectMy/artifacts/Encoders/PointNetSeg2New',
        'arch': arch,
        'lr': 1e-3,
        'classes': 4,
        'save_step': 5,
    ...
    backbone = PointNet2LiteBacbone(4)
    model = PointNet2LiteSegmentation(backbone, 4)
    logs = train(model, train_loader, config)
    save_logs_json(logs, '/home/rustam/ProjectMy/artifacts/Encoders/PointNetSeg2New/logs.json')
    torch.save(model.state_dict(), '/home/rustam/ProjectMy/artifacts/Encoders/PointNetSeg2New/fullModel.pth')
